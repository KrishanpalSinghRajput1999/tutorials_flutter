...
class _DetailPageState extends State<DetailPage> {
  ...
  _buildBody(BuildContext context) {
      ...
      slivers: <Widget>[
        ...
        new SliverFillRemaining(
          child: new Padding(
            ...
            child: new Column(
              children: <Widget>[
                new Text(widget.data['title'], style: Theme.of(context).textTheme.title,),
    ...
    return NestedScrollView(
      ...
      body: new Padding(padding: new EdgeInsets.all(24.0), child: new Column(
        children: <Widget>[
          new Text(widget.data['title'], style: Theme.of(context).textTheme.title,),
          new SizedBox(height: 12.0),
          new Row(
